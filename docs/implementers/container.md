...
services:
  sb29guard:
  image: ghcr.io/ricec-at-masonhs/sb29-guard:v1.x.x # prefer a version tag (or set SB29_IMAGE)
    ...
    spec:
      containers:
        - name: sb29guard
          ...
          # Tip: Use the published image tag (e.g., v1.1.0) or SB29_IMAGE for overrides
